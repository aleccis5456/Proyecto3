...
<header>
    <nav class="bg-gray-800 border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            ...
            <button href="" class="pr-10" type="button" data-drawer-target="drawer-navigation"
            ...
            <div>
                <a href=" {{ route('adm.index') }} " class="text-white text-center">Administracion de la pagina:
                    Proyecto</a>
            </div>
            ...
            <div class="text-white">
                @if (session('adm'))
                    <button class="rounded-lg hover:bg-gray-900 px-4 py-2 flex items-center space-x-2"
                        ...
                        <p class="text-white dark:text-white ">Hola, {{ session('adm')->nombre }} </p>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Estas seguro de cerrar
                                tu
                                cesion?</h3>
                            <a href=" {{ route('adm.logout') }} " data-modal-hide="popup-modal" type="button"
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href=" {{ route('adm.index') }} "
                        class="flex items-center space-x-2 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
