    ...
    <div class=""> <!-- Contenedor principal con Flexbox -->
        ...
        <div class="p-4"> <!-- 50% del ancho para el formulario -->
            <form class="max-w-sm mx-auto" method="POST" action="{{ route('editarSubSave') }}">
                ...
                <button type="submit"
                    class="text-white bg-gray-800 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar
                    Cambios</button>
            </form>
        </div>
    </div>
