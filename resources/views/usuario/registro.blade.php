...
@section('contenido')
    ...
    <div class="max-w-md mx-auto pt-6">
        <h1 class="text-4xl font-semibold text-gray-900 dark:text-white pb-9">Registrarme</h1>

        <div class="">
            <x-alertas />
        </div>

        <form class="" method="POST" action=" {{ route('usuario.registroSave') }} ">
            @csrf
            ...
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrarme</button>
        </form>
