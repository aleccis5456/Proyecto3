...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <div class="flex w-4/5 h-auto bg-white rounded-lg shadow-lg">        
        ...
        <div class="w-1/2 p-8">
            <x-alertas/>
            <form method="POST" action="{{ route('cajero.login') }}"            
                class="p-6 bg-gray-100 border border-gray-300 rounded-lg shadow-md backdrop-blur-sm bg-opacity-80">                            
                @csrf
                <div class="mb-6 text-center">
                    <b class="text-2xl text-gray-900 dark:text-white">Login de Cajeros</b>
                </div>
                <div class="mb-5">
                ...
                <div class="pt-12 text-center flex items-center justify-center">                   
                    ...
                    <a href="{{ route('vendedores.showlogin') }}" class="{{ Route::is('cajero.loginform') ? 'text-gray-500 font-semibold' : 'text-gray-500 text-sm hover:underline'}}">Caja</a>
                </div>
            </form>
        </div>
