<div class="">
    <div id="drawer-navigation"
        class="mt-[60px] fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-1/4 dark:bg-gray-800"
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    @foreach ($categorias as $categoria)
                        <button type="button"
                            class="text-lg flex items-center w-full p-2  text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100"
                            aria-controls="dropdown-{{ $categoria->id }}"
                            data-collapse-toggle="dropdown-{{ $categoria->id }}">
                            <span>
                                <img class="w-[24px] h-[24px]"
                                    src="{{ asset("uploads/categorias/$categoria->imagen") }}" alt=""
                                    srcset="">
                            </span>
