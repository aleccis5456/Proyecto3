<div>
    ...
    @if ($errors->any())
        <div id="alerta"
            ...
            role="alert">
            <svg class="flex-shrink-0 inline w-4 h-4 me-3" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="relative p-4 w-full max-w-md">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 20">
...
<div id="alerta-modal" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md">
        <div class="relative bg-yellow-50 rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                <svg class="mx-auto mb-4 text-[#fbb321] w-12 h-12 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 25">
                    <circle cx="12.5" cy="12.5" r="11" stroke="currentColor" stroke-width="2"/>
                    <path d="M9.5 12.5l2.5 2.5 5-5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¡Producto agregado al carrito!</h3>                    
                <button onclick="closeAlert()" type="button" 
                    class="text-gray-800 bg-[#fbb321] hover:bg-yellow-200 hover:text-gray-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-green-800">
                    Aceptar
                </button>
            </div>                
        </div>
