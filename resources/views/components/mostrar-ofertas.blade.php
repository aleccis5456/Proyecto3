<div>
    ...
    <div class="relative py-10">    
        <div class="absolute inset-0 flex items-center justify-center">
            <div class="bg-blue-600 h-12 transform w-2/3"></div>
        </div>        
    ...
    @endif
        ...
        @if ($ofertas->isNotEmpty())
            ...
            <div class="relative py-10">
                <!-- Cinta horizontal -->
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="bg-white h-12 transform -skew-y-2 w-full"></div>
                </div>
        
                <!-- Texto con cinta -->
                <p class="relative text-blue-600 text-3xl font-bold text-center px-4">
                    Algunos de nuestros productos
                </p>
            </div>
            @endif --}}
